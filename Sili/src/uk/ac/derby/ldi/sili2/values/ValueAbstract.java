...
public abstract class ValueAbstract implements Value {
	...
	public Value percentage(Value v) {
		throw new ExceptionSemantic("Cannot perform % on " + getName() + " and " + v.getName());
	}
	
	public Value cos() {
		throw new ExceptionSemantic("Cannot perform 'cos' on " + getName());
	}
	
	public Value sin() {
		throw new ExceptionSemantic("Cannot perform 'sin' on " + getName());
	}
	
	public Value tan() {
		throw new ExceptionSemantic("Cannot perform 'tan' on " + getName());
	}
	
	public Value icos() {
		throw new ExceptionSemantic("Cannot perform 'icos' on " + getName());
	}
	
	public Value isin() {
		throw new ExceptionSemantic("Cannot perform 'isin' on " + getName());
	}
	
	public Value itan() {
		throw new ExceptionSemantic("Cannot perform 'itan' on " + getName());
	}
